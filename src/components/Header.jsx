...
const Header = ()=>{
    ...
    return(
        ...
        <div className=" w-full flex justify-center px-4 items-center  lg:w-320 lg:px-4 lg:flex-row mx-auto  lg:justify-between ">
            <p className="bg-[#EEEBFF] text-[#7B61FF] my-auto text-lg  w-12 h-12 rounded-full flex items-center justify-center rotate-0 font-semibold lg:text-[22px] lg:w-16 lg:h-16 dark:text-[#8F88FF] dark:bg-[#4731D3] ">{content.header.logo}</p>
